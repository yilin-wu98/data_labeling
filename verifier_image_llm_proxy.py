...
def call_gpt_with_images(api_key: str, img_files: List[str], instruction_text: str, timeout: float, query_type: str = 'moment') -> str:
    ...
    try:
        response = requests.post(
            "https://llm-proxy.perflab.nvidia.com/openai/deployments/gpt-4o-20240806/chat/completions?api-version=2024-12-01-preview",
            headers={
...
def main():
    ...
    api_key = load_api_key("llm-proxy")
    ...
    for idx, vid_filename in tqdm(enumerate(image_files)):
        ...
        instruction_text = "Pick up the cream cheese box"
